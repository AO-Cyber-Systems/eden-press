...
- [Objective 05-convert-raster]: convert/pdf.Options kept as an intentionally-empty named struct (not aliased to convert.Options) for forward-compat since ToPDF receives an already-built *chrome.Session
...
| Objective 05-convert-raster P03 | 9min | 2 tasks | 5 files |
