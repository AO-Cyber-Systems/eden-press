...
- [ ] **Objective 5.1: CLI Raster Export Binary (eden-press-export)** [INSERTED] - separate Chrome-permitting `eden-press-export --format pdf|png` binary; core `eden-press` stays chromedp-free (in progress).
