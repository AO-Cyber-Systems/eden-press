...
- [ ] **Objective 4.1: CLI Agent Interface (AI-usability, Chrome-free)** [INSERTED] - `--format json` structured Output + Chrome-free `--format pptx` + machine-readable errors/exit-codes + AGENTS.md; CLI stays chromedp-free (in progress).
